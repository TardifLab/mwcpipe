#!/bin/bash
#
# Registers T1w --> dwi space using a nonlinear SyN method applying the parameters given as input
#
#
# # INPUTS:
#       $1 : id  = num in (01..30)
...
# Rigid + Affine + SyN
  ...
  T1nativepro_brain_in_dwi_syn=${testdir_dwi}/${idBIDS}_space-dwi_desc-syn-${TAG}_t1w_brain.nii.gz
  T1nativepro_in_dwi_syn=${testdir_dwi}/${idBIDS}_space-dwi_desc-syn-${TAG}_t1w.nii.gz
