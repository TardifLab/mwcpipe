...
#------------------------------------------------------------------------------------------------------------------------------------
  ...
  SES="1"
  vm=15
  script=/data_/tardiflab/mwc/mwcpipe/tardiflab/scripts/01_processing/tmp_regtest/regtest_dwi_t1w_testANTs_syn.sh
...
#  declare -a SYNSMOOTH=("3x0" "2x0" "1x0")
  ...
  logdir=/data_/tardiflab/mwc/bids/derivatives/micapipe/tmp_micapipe/02_proc-dwi/sub-${id}/ses-${SES}/tmpregtest_testANTs/ants_0_test_rigid/qbatchlogs
